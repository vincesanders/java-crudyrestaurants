 ...
 */
@Transactional
@Component //Comment out to use data.sql to seed data
public class SeedData implements CommandLineRunner {
    ...
    public void run(String[] args) {
        ...
        r1.getPayments().add(pay1);
        r1.getPayments().add(pay2);
        r1.getPayments().add(pay3);
        ...
        r3.getPayments().add(pay2);
        r3.getPayments().add(pay3);
